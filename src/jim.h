...
std::shared_ptr<Jim> azimuth(Jim& imRaster_iy, int iband=0);
CPLErr d_azimuth(Jim& imRaster_iy, int iband=0);
std::shared_ptr<Jim> mapori(int  ox, int  oy, int iband=0);
CPLErr d_mapori(int  ox, int  oy, int iband=0);
std::shared_ptr<Jim> dir(int  graph, int iband=0);
CPLErr d_dir(int  graph, int iband=0);
std::shared_ptr<Jim> cboutlet(Jim& imRaster_d8, int iband=0);
CPLErr d_cboutlet(Jim& imRaster_d8, int iband=0);
std::shared_ptr<Jim> cbconfluence(Jim& imRaster_d8, int iband=0);
CPLErr d_cbconfluence(Jim& imRaster_d8, int iband=0);
std::shared_ptr<Jim> strahler(int iband=0);
CPLErr d_strahler(int iband=0);
std::shared_ptr<Jim> FlatIGeodAFAB(Jim& imRaster_im, int  graph, int iband=0);
CPLErr d_FlatIGeodAFAB(Jim& imRaster_im, int  graph, int iband=0);
std::shared_ptr<Jim> dst2d4(int iband=0);
CPLErr d_dst2d4(int iband=0);
std::shared_ptr<Jim> dst2dchamfer(int iband=0);
CPLErr d_dst2dchamfer(int iband=0);
std::shared_ptr<Jim> chamfer2d(int  type, int iband=0);
CPLErr d_chamfer2d(int  type, int iband=0);
std::shared_ptr<Jim> oiiz(int iband=0);
CPLErr d_oiiz(int iband=0);
std::shared_ptr<Jim> geodist(Jim& imRaster_im_r, int  graph, int iband=0);
CPLErr d_geodist(Jim& imRaster_im_r, int  graph, int iband=0);
std::shared_ptr<Jim> linero(int  dx, int  dy, int  n, int  line_type, int iband=0);
CPLErr d_linero(int  dx, int  dy, int  n, int  line_type, int iband=0);
std::shared_ptr<Jim> lindil(int  dx, int  dy, int  n, int  line_type, int iband=0);
CPLErr d_lindil(int  dx, int  dy, int  n, int  line_type, int iband=0);
std::shared_ptr<Jim> herkpldil(int  dx, int  dy, int  k, int  o, int  t, int iband=0);
CPLErr d_herkpldil(int  dx, int  dy, int  k, int  o, int  t, int iband=0);
std::shared_ptr<Jim> herkplero(int  dx, int  dy, int  k, int  o, int  t, int iband=0);
CPLErr d_herkplero(int  dx, int  dy, int  k, int  o, int  t, int iband=0);
std::shared_ptr<Jim> linerank(int  dx, int  dy, int  k, int  rank, int  o, int iband=0);
CPLErr d_linerank(int  dx, int  dy, int  k, int  rank, int  o, int iband=0);
std::shared_ptr<Jim> to_uchar(int iband=0);
CPLErr d_to_uchar(int iband=0);
std::shared_ptr<Jim> dbltofloat(int iband=0);
CPLErr d_dbltofloat(int iband=0);
std::shared_ptr<Jim> uint32_to_float(int iband=0);
CPLErr d_uint32_to_float(int iband=0);
std::shared_ptr<Jim> swap(int iband=0);
CPLErr d_swap(int iband=0);
std::shared_ptr<Jim> rdil(Jim& imRaster_mask, int  graph, int  flag, int iband=0);
CPLErr d_rdil(Jim& imRaster_mask, int  graph, int  flag, int iband=0);
std::shared_ptr<Jim> rero(Jim& imRaster_mask, int  graph, int  flag, int iband=0);
CPLErr d_rero(Jim& imRaster_mask, int  graph, int  flag, int iband=0);
std::shared_ptr<Jim> rerodilp(Jim& imRaster_mask, int  graph, int  flag, int  version, int iband=0);
CPLErr d_rerodilp(Jim& imRaster_mask, int  graph, int  flag, int  version, int iband=0);
std::shared_ptr<Jim> complete(Jim& imRaster_im_rmin, int  graph, int iband=0);
CPLErr d_complete(Jim& imRaster_im_rmin, int  graph, int iband=0);
std::shared_ptr<Jim> sqtgpla(Jim& imRaster_im_r, int  graph, int iband=0);
CPLErr d_sqtgpla(Jim& imRaster_im_r, int  graph, int iband=0);
std::shared_ptr<Jim> sqtg(Jim& imRaster_im_r, int  graph, int iband=0);
CPLErr d_sqtg(Jim& imRaster_im_r, int  graph, int iband=0);
std::shared_ptr<Jim> framebox(int * box, double d_gval, int iband=0);
CPLErr d_framebox(int * box, double d_gval, int iband=0);
std::shared_ptr<Jim> addframebox(int * box, double d_gval, int iband=0);
CPLErr d_addframebox(int * box, double d_gval, int iband=0);
std::shared_ptr<Jim> subframebox(int * box, int iband=0);
CPLErr d_subframebox(int * box, int iband=0);
std::shared_ptr<Jim> dumpxyz(int  x, int  y, int  z, int  dx, int  dy, int iband=0);
CPLErr d_dumpxyz(int  x, int  y, int  z, int  dx, int  dy, int iband=0);
std::shared_ptr<Jim> imputop(Jim& imRaster_im2, int  x, int  y, int  z, int  op, int iband=0);
CPLErr d_imputop(Jim& imRaster_im2, int  x, int  y, int  z, int  op, int iband=0);
std::shared_ptr<Jim> imputcompose(Jim& imRaster_imlbl, Jim& imRaster_im2, int  x, int  y, int  z, int  val, int iband=0);
CPLErr d_imputcompose(Jim& imRaster_imlbl, Jim& imRaster_im2, int  x, int  y, int  z, int  val, int iband=0);
std::shared_ptr<Jim> szcompat(Jim& imRaster_im2, int iband=0);
CPLErr d_szcompat(Jim& imRaster_im2, int iband=0);
std::shared_ptr<Jim> szgeocompat(Jim& imRaster_im2, int iband=0);
CPLErr d_szgeocompat(Jim& imRaster_im2, int iband=0);
std::shared_ptr<Jim> plotline(int  x1, int  y1, int  x2, int  y2, int  val, int iband=0);
CPLErr d_plotline(int  x1, int  y1, int  x2, int  y2, int  val, int iband=0);
std::shared_ptr<Jim> ovlmatrix(Jim& imRaster_maxg_array, char * odir, int iband=0);
CPLErr d_ovlmatrix(Jim& imRaster_maxg_array, char * odir, int iband=0);
std::shared_ptr<Jim> skeleton(int iband=0);
CPLErr d_skeleton(int iband=0);
std::shared_ptr<Jim> bprune(int  occa, int  graph, int iband=0);
CPLErr d_bprune(int  occa, int  graph, int iband=0);
std::shared_ptr<Jim> oiskeleton(Jim& imRaster_imanchor, int iband=0);
CPLErr d_oiskeleton(Jim& imRaster_imanchor, int iband=0);
std::shared_ptr<Jim> oiask(Jim& imRaster_imanchor, int iband=0);
CPLErr d_oiask(Jim& imRaster_imanchor, int iband=0);
std::shared_ptr<Jim> binODthin_noqueue(int  stype, int  atype, Jim& imRaster_imanchor, int iband=0);
CPLErr d_binODthin_noqueue(int  stype, int  atype, Jim& imRaster_imanchor, int iband=0);
std::shared_ptr<Jim> binODthin_FIFO(int  stype, int  atype, Jim& imRaster_imanchor, int iband=0);
CPLErr d_binODthin_FIFO(int  stype, int  atype, Jim& imRaster_imanchor, int iband=0);
std::shared_ptr<Jim> binOIthin_noqueue(int  stype, int  atype, Jim& imRaster_imanchor, int iband=0);
CPLErr d_binOIthin_noqueue(int  stype, int  atype, Jim& imRaster_imanchor, int iband=0);
std::shared_ptr<Jim> binOIthin_FIFO(int  stype, int  atype, Jim& imRaster_imanchor, int iband=0);
CPLErr d_binOIthin_FIFO(int  stype, int  atype, Jim& imRaster_imanchor, int iband=0);
std::shared_ptr<Jim> iminfo(int iband=0);
CPLErr d_iminfo(int iband=0);
std::shared_ptr<Jim> copy_lut(Jim& imRaster_im2, int iband=0);
CPLErr d_copy_lut(Jim& imRaster_im2, int iband=0);
std::shared_ptr<Jim> create_lut(int iband=0);
CPLErr d_create_lut(int iband=0);
std::shared_ptr<Jim> setpixval(unsigned long  offset, double d_g, int iband=0);
CPLErr d_setpixval(unsigned long  offset, double d_g, int iband=0);
std::shared_ptr<Jim> write_ColorMap_tiff(char * fn, int iband=0);
CPLErr d_write_ColorMap_tiff(char * fn, int iband=0);
std::shared_ptr<Jim> write_tiff(char * fn, int iband=0);
CPLErr d_write_tiff(char * fn, int iband=0);
std::shared_ptr<Jim> writeTiffOneStripPerLine(char * fn, char * desc, int iband=0);
CPLErr d_writeTiffOneStripPerLine(char * fn, char * desc, int iband=0);
std::shared_ptr<Jim> writeGeoTiffOneStripPerLine(char * fn, int  PCSCode, double  xoff, double  yoff, double  scale, unsigned short  RasterType, int  nodata_flag, int  nodata_val, int  metadata_flag, char * metadata_str, int iband=0);
...
std::shared_ptr<Jim> label(Jim& imRaster_im2, int  ox, int  oy, int  oz, int iband=0);
CPLErr d_label(Jim& imRaster_im2, int  ox, int  oy, int  oz, int iband=0);
std::shared_ptr<Jim> labelpixngb(Jim& imRaster_im2, int  ox, int  oy, int  oz, int iband=0);
CPLErr d_labelpixngb(Jim& imRaster_im2, int  ox, int  oy, int  oz, int iband=0);
std::shared_ptr<Jim> labelplat(Jim& imRaster_im2, int  ox, int  oy, int  oz, int iband=0);
CPLErr d_labelplat(Jim& imRaster_im2, int  ox, int  oy, int  oz, int iband=0);
std::shared_ptr<Jim> seededlabelplat(Jim& imRaster_im2, Jim& imRaster_im3, int  ox, int  oy, int  oz, int iband=0);
CPLErr d_seededlabelplat(Jim& imRaster_im2, Jim& imRaster_im3, int  ox, int  oy, int  oz, int iband=0);
std::shared_ptr<Jim> seededplat(Jim& imRaster_im2, Jim& imRaster_im3, int  ox, int  oy, int  oz, int iband=0);
CPLErr d_seededplat(Jim& imRaster_im2, Jim& imRaster_im3, int  ox, int  oy, int  oz, int iband=0);
std::shared_ptr<Jim> labelpix(int iband=0);
CPLErr d_labelpix(int iband=0);
std::shared_ptr<Jim> resolveLabels(Jim& imRaster_imlut, Jim& imRaster_imlutback, int  graph, int iband=0);
CPLErr d_resolveLabels(Jim& imRaster_imlut, Jim& imRaster_imlutback, int  graph, int iband=0);
std::shared_ptr<Jim> gorder(Jim& imRaster_g, int  n, int iband=0);
CPLErr d_gorder(Jim& imRaster_g, int  n, int iband=0);
std::shared_ptr<Jim> propagate(Jim& imRaster_dst, IMAGE ** imap, int  nc, int  graph, int iband=0);
CPLErr d_propagate(Jim& imRaster_dst, IMAGE ** imap, int  nc, int  graph, int iband=0);
std::shared_ptr<Jim> set_regions(Jim& imRaster_ival, int  indic, int iband=0);
CPLErr d_set_regions(Jim& imRaster_ival, int  indic, int iband=0);
std::shared_ptr<Jim> setregionsgraph(Jim& imRaster_ival, int  indic, int  graph, int iband=0);
CPLErr d_setregionsgraph(Jim& imRaster_ival, int  indic, int  graph, int iband=0);
std::shared_ptr<Jim> tessel_surface(int iband=0);
CPLErr d_tessel_surface(int iband=0);
std::shared_ptr<Jim> relabel(Jim& imRaster_ilbl2, Jim& imRaster_iarea2, int iband=0);
CPLErr d_relabel(Jim& imRaster_ilbl2, Jim& imRaster_iarea2, int iband=0);
std::shared_ptr<Jim> bitwise_op(Jim& imRaster_im2, int  op, int iband=0);
CPLErr d_bitwise_op(Jim& imRaster_im2, int  op, int iband=0);
std::shared_ptr<Jim> negation(int iband=0);
...
std::shared_ptr<Jim> arithcst(double d_gt, int  op, int iband=0);
CPLErr d_arithcst(double d_gt, int  op, int iband=0);
std::shared_ptr<Jim> imabs(int iband=0);
CPLErr d_imabs(int iband=0);
std::shared_ptr<Jim> imsqrt(int iband=0);
CPLErr d_imsqrt(int iband=0);
std::shared_ptr<Jim> imlog(int iband=0);
CPLErr d_imlog(int iband=0);
std::shared_ptr<Jim> imatan(int iband=0);
CPLErr d_imatan(int iband=0);
std::shared_ptr<Jim> imcos(int iband=0);
CPLErr d_imcos(int iband=0);
std::shared_ptr<Jim> imacos(int iband=0);
CPLErr d_imacos(int iband=0);
std::shared_ptr<Jim> imsin(int iband=0);
CPLErr d_imsin(int iband=0);
std::shared_ptr<Jim> imasin(int iband=0);
CPLErr d_imasin(int iband=0);
std::shared_ptr<Jim> thresh(double d_gt1, double d_gt2, double d_gbg, double d_gfg, int iband=0);
CPLErr d_thresh(double d_gt1, double d_gt2, double d_gbg, double d_gfg, int iband=0);
std::shared_ptr<Jim> setlevel(double d_gt1, double d_gt2, double d_gval, int iband=0);
CPLErr d_setlevel(double d_gt1, double d_gt2, double d_gval, int iband=0);
std::shared_ptr<Jim> modulo(int  val, int iband=0);
CPLErr d_modulo(int  val, int iband=0);
std::shared_ptr<Jim> complement(int iband=0);
CPLErr d_complement(int iband=0);
std::shared_ptr<Jim> power2p(int iband=0);
CPLErr d_power2p(int iband=0);
std::shared_ptr<Jim> blank(double d_gval, int iband=0);
CPLErr d_blank(double d_gval, int iband=0);
std::shared_ptr<Jim> shift(int  val, int iband=0);
CPLErr d_shift(int  val, int iband=0);
std::shared_ptr<Jim> setrange(double d_gt1, double d_gt2, int iband=0);
CPLErr d_setrange(double d_gt1, double d_gt2, int iband=0);
std::shared_ptr<Jim> FindPixWithVal(double d_gval, unsigned long int * ofs, int iband=0);
CPLErr d_FindPixWithVal(double d_gval, unsigned long int * ofs, int iband=0);
std::shared_ptr<Jim> wsfah(Jim& imRaster_imr, int  graph, int  maxfl, int iband=0);
CPLErr d_wsfah(Jim& imRaster_imr, int  graph, int  maxfl, int iband=0);
std::shared_ptr<Jim> skelfah(Jim& imRaster_imr, Jim& imRaster_imdir, int  graph, int  maxfl, int iband=0);
CPLErr d_skelfah(Jim& imRaster_imr, Jim& imRaster_imdir, int  graph, int  maxfl, int iband=0);
std::shared_ptr<Jim> skelfah2(Jim& imRaster_impskp, int  n, int  graph, int iband=0);
CPLErr d_skelfah2(Jim& imRaster_impskp, int  n, int  graph, int iband=0);
std::shared_ptr<Jim> compose(Jim& imRaster_mask, Jim& imRaster_g, Jim& imRaster_lbl, int  graph, int iband=0);
CPLErr d_compose(Jim& imRaster_mask, Jim& imRaster_g, Jim& imRaster_lbl, int  graph, int iband=0);
std::shared_ptr<Jim> oiws(int iband=0);
CPLErr d_oiws(int iband=0);
std::shared_ptr<Jim> srg(Jim& imRaster_im2, Jim& imRaster_im3, int  ox, int  oy, int  oz, int iband=0);
CPLErr d_srg(Jim& imRaster_im2, Jim& imRaster_im3, int  ox, int  oy, int  oz, int iband=0);
std::shared_ptr<Jim> IsPartitionEqual(Jim& imRaster_im2, int * result, int iband=0);
CPLErr d_IsPartitionEqual(Jim& imRaster_im2, int * result, int iband=0);
std::shared_ptr<Jim> IsPartitionFiner(Jim& imRaster_im2, int  graph, unsigned long int * res, int iband=0);
CPLErr d_IsPartitionFiner(Jim& imRaster_im2, int  graph, unsigned long int * res, int iband=0);
std::shared_ptr<Jim> getfirstmaxpos(unsigned long int * pos, int iband=0);
CPLErr d_getfirstmaxpos(unsigned long int * pos, int iband=0);
std::shared_ptr<Jim> histcompress(int iband=0);
CPLErr d_histcompress(int iband=0);
std::shared_ptr<Jim> lookup(Jim& imRaster_imlut, int iband=0);
CPLErr d_lookup(Jim& imRaster_imlut, int iband=0);
std::shared_ptr<Jim> lookuptypematch(Jim& imRaster_imlut, int iband=0);
CPLErr d_lookuptypematch(Jim& imRaster_imlut, int iband=0);
std::shared_ptr<Jim> volume(int iband=0);
CPLErr d_volume(int iband=0);
std::shared_ptr<Jim> dirmax(int  dir, int iband=0);
CPLErr d_dirmax(int  dir, int iband=0);
std::shared_ptr<Jim> imequalp(Jim& imRaster_im2, int iband=0);
CPLErr d_imequalp(Jim& imRaster_im2, int iband=0);
std::shared_ptr<Jim> getmax(double * maxval, int iband=0);
CPLErr d_getmax(double * maxval, int iband=0);
std::shared_ptr<Jim> getminmax(double * minval, double * maxval, int iband=0);
CPLErr d_getminmax(double * minval, double * maxval, int iband=0);
std::shared_ptr<Jim> classstatsinfo(Jim& imRaster_imin, int iband=0);
CPLErr d_classstatsinfo(Jim& imRaster_imin, int iband=0);
std::shared_ptr<Jim> clmindist(Jim& imRaster_imin, int  bklabel, int  mode, double  thr, int iband=0);
CPLErr d_clmindist(Jim& imRaster_imin, int  bklabel, int  mode, double  thr, int iband=0);
std::shared_ptr<Jim> clparpip(Jim& imRaster_imin, int  bklabel, int  mode, double  mult, int iband=0);
CPLErr d_clparpip(Jim& imRaster_imin, int  bklabel, int  mode, double  mult, int iband=0);
std::shared_ptr<Jim> clmaha(Jim& imRaster_imin, int  bklabel, int  mode, double  thr, int iband=0);
CPLErr d_clmaha(Jim& imRaster_imin, int  bklabel, int  mode, double  thr, int iband=0);
std::shared_ptr<Jim> clmaxlike(Jim& imRaster_imin, int  bklabel, int  type, double  thr, int iband=0);
