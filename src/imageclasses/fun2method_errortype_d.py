    ...
    for line in lines:
        ...
        for idx, arg in enumerate(a.get("arguments")[1:len(a.get("arguments"))]):
            ...
            if (arg[0]=='IMAGE *'):
                ...
                imDeclare.append(arg[0]+' '+arg[1]+' = (this!=&imRaster_'+arg[1]+')? imRaster_'+arg[1]+'.getMIA(iband) : '+a.get("arguments")[0][1]+';')
        ...
        f.write('\n\t\t\t'+a.get("arguments")[0][0]+' '+a.get("arguments")[0][1]+' = this->getMIA(iband);') # only for destructive version
        llen=len(imDeclare)
