...
# cat /usr/local/include/mialib/mialib_*.h | grep '^extern ERROR'  > mialib_error_type_nm
# python fun2method_errortype_d_nm.py  -i mialib_error_type -o fun2method_errortype_d_nm
