...
#include "miallib/miallib_dem.h"
#include "miallib/miallib_dist.h"
#include "miallib/miallib_erodil.h"
#include "miallib/miallib_format.h"
#include "miallib/miallib_geodesy.h"
#include "miallib/miallib_geometry.h"
#include "miallib/miallib_hmt.h"
#include "miallib/miallib_imem.h"
#include "miallib/miallib_io.h"
#include "miallib/miallib_label.h"
#include "miallib/miallib_miscel.h"
#include "miallib/miallib_opclo.h"
#include "miallib/miallib_pointop.h"
#include "miallib/miallib_proj.h"
#include "miallib/miallib_segment.h"
#include "miallib/miallib_stats.h"
...
class Jim : public std::enable_shared_from_this<Jim>
{
 ...
 static std::shared_ptr<Jim> createImg(const std::string filename, bool readData=true, unsigned int memory=0);
  ...
  void d_setMask(VectorOgr& ogrReader, app::AppFactory& app);
  ///set mask to raster dataset
  //todo: create template function and make it work for 3D
